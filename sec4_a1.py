...
print("For scenario A1 bandwidth varies from " + str(np.min(bw)) + " to " + str(np.max(bw)) + " Hz")
print("For scenario A1 irradiance varies from " + str(np.min(G_all)) + " to " + str(np.max(G_all)) + " W/m2")
