...
arrb = gen_points(0.4,9.6,0.4,9.6,0,10,10,False) #SNs positions
arr_m = np.array([5,5,3]) #MN position
...
designs = {
  'A' :  {
    ...
    'amb_L1' : 2,
    'amb_L2' : 1,
    'nR_sensor' : np.round(align_receiver_to_transmitter(arrb, arr_m),2),
    'nS_sensor' : align_receiver_to_transmitter(arrb, arr_m),
  ...
  'B' :  {
    ...
    'amb_L2' : 0,
    'nR_sensor' : np.round(align_receiver_to_transmitter(arrb, arr_m),2),
    'nS_sensor' : np.round(align_receiver_to_transmitter(arrb, arr_m),2),
    'nR_master' : -constants.ez,
    'nS_master' : -constants.ez,
    'no_bounces' : 4,
    'Rb_master' : 10e3,
